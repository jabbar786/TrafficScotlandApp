package com.example.jghafo.trafficscotlandapp.UserInterfaces.CurrentRoadworks;
...
public class CurrentRoadWorksAdapter extends RecyclerView.Adapter<CurrentRoadWorksAdapter.WorksViewHolder> {
    ...
    public CurrentRoadWorksAdapter(Context context, List<RSSFeed> RSSFeeds, List<RSSFeed> filterItems, AdapterListener listener){
    ...
    @NonNull
    @Override
    public CurrentRoadWorksAdapter.WorksViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CurrentRoadWorksAdapter.WorksViewHolder holder, int position) {
